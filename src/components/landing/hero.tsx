    ...
    <>
      <section className="relative h-screen  flex items-center overflow-hidden pt-10 ">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center w-400 mx-auto max-w-7xl">
              ...
              <div className="grid lg:grid-cols-1 gap-16 items-center">
                ...
                <div className="space-y-10">
                  <div className="space-y-6">
                    ...
                    <div
                      aria-hidden="true"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary5 rounded-full border border-primary/20 backdrop-blur-sm"
                    >
                      <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                      <h4 className="text-sm font-medium text-primary">
                        AI-driven Dental Assistant.
                      </h4>
                    </div>
          ...
          {/* Right Content */}
          <div className="relative pr-6 items-center ">
            {/* GRADIENT ORBS */}
